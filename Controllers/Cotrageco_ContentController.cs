...
namespace Cotrageco.Controllers
{
    public class Cotrageco_ContentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Cotrageco_ContentId,Objective_Title,Objective_Description,Project_Title,Project_Description,AboutUs_Title,AboutUs_Description,AboutUs_Banner,Presentation_Title,Company_Presentaion,Registration_Description,OFS_Title,OFS_Description,Services_Title,Services_Description,Services_Banner,Realisations_Title,Realisations_Description,Contact_Title,Contact_Description,Conatct_Banner")] Cotrageco_Content cotrageco_Content)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cotrageco_ContentId,Objective_Title,Objective_Description,Project_Title,Project_Description,AboutUs_Title,AboutUs_Description,AboutUs_Banner,Presentation_Title,Company_Presentaion,Registration_Description,OFS_Title,OFS_Description,Services_Title,Services_Description,Services_Banner,Realisations_Title,Realisations_Description,Contact_Title,Contact_Description,Conatct_Banner")] Cotrageco_Content cotrageco_Content)
        {
